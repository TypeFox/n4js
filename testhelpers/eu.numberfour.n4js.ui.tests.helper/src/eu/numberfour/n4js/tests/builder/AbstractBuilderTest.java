 ...
 *******************************************************************************/
package eu.numberfour.n4js.tests.builder;

import static eu.numberfour.n4js.tests.builder.BuilderUtil.countResourcesInIndex;
import static eu.numberfour.n4js.tests.builder.BuilderUtil.getAllResourceDescriptionsAsString;
import static eu.numberfour.n4js.tests.builder.BuilderUtil.getBuilderState;
