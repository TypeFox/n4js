...
ruleScriptElement :
	...
	( (
	ruleN4Modifier* 'class' ruleTypingStrategyDefSiteOperator?
	...
	( (
	ruleN4Modifier* 'enum' ruleBindingIdentifier?
...
ruleAnnotatedScriptElement :
	...
	'@' (
		...
		( (
		ruleN4Modifier* ruleAsyncNoTrailingLineBreak 'function'
		) => (
			ruleN4Modifier* ruleAsyncNoTrailingLineBreak ( (
			'function'
			) => ruleFunctionImpl )
		) ) |
		(
			ruleN4Modifier* 'class' ruleTypingStrategyDefSiteOperator?
			ruleBindingIdentifier ruleTypeVariables? ruleClassExtendsClause? |
			ruleN4Modifier* 'interface' ruleTypingStrategyDefSiteOperator?
			ruleBindingIdentifier ruleTypeVariables? ruleInterfaceImplementsList?
		) ruleMembers |
		ruleN4Modifier* 'enum' ruleBindingIdentifier '{' ruleN4EnumLiteral (
			',' ruleN4EnumLiteral
		)* '}'
	)
;
...
ruleExportDeclarationImpl :
	'export' (
		...
		'default' (
			...
			norm1_AssignmentExpression ruleSemi
		)
	)
;
...
ruleAnnotatedExportableElement :
	...
	'@' (
		...
		ruleN4Modifier* ruleAsyncNoTrailingLineBreak ruleFunctionImpl |
		ruleN4Modifier* ruleVariableStatementKeyword
...
ruleImportDeclarationImpl :
	'import' (
		ruleImportClause 'from'
	)? ruleModuleSpecifier ruleSemi
;
...
ruleNamedImportSpecifier :
	ruleBindingIdentifier |
	ruleIdentifierName 'as' ruleBindingIdentifier
;
...
ruleFunctionImpl :
	'function' (
		'*' norm2_FunctionHeader norm1_FunctionBody |
		ruleFunctionHeader ruleFunctionBody
	)
;
...
norm3_FunctionImpl :
	'function' (
		'*' norm3_FunctionHeader norm1_FunctionBody |
		norm1_FunctionHeader ruleFunctionBody
	)
;
...
norm6_FunctionImpl :
	'function' (
		'*' norm3_FunctionHeader norm3_FunctionBody |
		ruleFunctionHeader norm2_FunctionBody
	)
;

// Rule FunctionHeader
ruleFunctionHeader :
	ruleTypeVariables? ruleBindingIdentifier? ruleStrictFormalParameters (
		( (
		':'
		) => ':' ) ruleTypeRef
	)?
...
norm1_FunctionHeader :
	ruleTypeVariables? norm1_BindingIdentifier? ruleStrictFormalParameters (
		( (
		':'
		) => ':' ) ruleTypeRef
	)?
...
norm2_FunctionHeader :
	ruleTypeVariables? ruleBindingIdentifier? norm1_StrictFormalParameters (
		( (
		':'
		) => ':' ) ruleTypeRef
	)?
...
norm3_FunctionHeader :
	ruleTypeVariables? norm1_BindingIdentifier? norm1_StrictFormalParameters (
		( (
		':'
		) => ':' ) ruleTypeRef
	)?
...
ruleAnnotatedFunctionDeclaration :
	...
	) => ruleAnnotationList ) ruleN4Modifier* ruleAsyncNoTrailingLineBreak
	ruleFunctionImpl
;
...
ruleAnnotatedExpression :
	ruleExpressionAnnotationList (
		'class' ruleBindingIdentifier? ruleClassExtendsClause? ruleMembers |
		ruleAsyncNoTrailingLineBreak norm6_FunctionImpl
	)
;
...
norm1_AnnotatedExpression :
	ruleExpressionAnnotationList (
		'class' norm1_BindingIdentifier? norm1_ClassExtendsClause? norm1_Members |
		ruleAsyncNoTrailingLineBreak norm6_FunctionImpl
	)
;
...
norm1_VariableStatement :
	( (
	ruleVariableStatementKeyword
	) => ruleVariableStatementKeyword ) norm1_VariableDeclarationOrBinding (
...
norm3_VariableStatement :
	( (
	ruleVariableStatementKeyword
	) => ruleVariableStatementKeyword ) norm3_VariableDeclarationOrBinding (
...
norm4_VariableDeclarationImpl :
	ruleAnnotation* (
		( (
		ruleBindingIdentifier ruleColonSepTypeRef?
		) => (
			ruleBindingIdentifier ruleColonSepTypeRef?
		) ) (
			'=' ruleAssignmentExpression
...
norm6_VariableDeclarationImpl :
	ruleAnnotation* (
		( (
		norm1_BindingIdentifier ruleColonSepTypeRef?
		) => (
			norm1_BindingIdentifier ruleColonSepTypeRef?
		) ) (
			'=' norm2_AssignmentExpression
...
ruleExportedVariableBinding :
	( (
	ruleBindingPattern
	) => ruleBindingPattern ) '=' norm1_AssignmentExpression
;
...
norm1_ExportedVariableBinding :
	( (
	norm1_BindingPattern
	) => norm1_BindingPattern ) '=' norm3_AssignmentExpression
;
...
ruleExpressionStatement :
	norm1_Expression ruleSemi
;

// Rule ExpressionStatement
norm1_ExpressionStatement :
	norm3_Expression ruleSemi
;

// Rule IfStatement
ruleIfStatement :
	'if' '(' norm1_Expression ')' ruleStatement (
		( (
		'else'
		) => 'else' ) ruleStatement
	)?
...
// Rule IfStatement
norm1_IfStatement :
	'if' '(' norm3_Expression ')' norm1_Statement (
		( (
		'else'
		) => 'else' ) norm1_Statement
	)?
;
...
// Rule DoStatement
ruleDoStatement :
	'do' ruleStatement 'while' '(' norm1_Expression ')' ( (
	ruleSemi
	) => ruleSemi )?
;
...
// Rule DoStatement
norm1_DoStatement :
	'do' norm1_Statement 'while' '(' norm3_Expression ')' ( (
	ruleSemi
	) => ruleSemi )?
;
...
// Rule WhileStatement
ruleWhileStatement :
	'while' '(' norm1_Expression ')' ruleStatement
;

// Rule WhileStatement
norm1_WhileStatement :
	'while' '(' norm3_Expression ')' norm1_Statement
;
...
ruleForStatement :
	'for' '(' (
		( (
		ruleLetIdentifierRef 'in' norm1_Expression ')'
		) => (
			ruleLetIdentifierRef 'in' norm1_Expression ')'
		) ) |
		(
...
norm1_ForStatement :
	'for' '(' (
		( (
		ruleLetIdentifierRef 'in' norm3_Expression ')'
		) => (
			ruleLetIdentifierRef 'in' norm3_Expression ')'
		) ) |
		(
...
ruleContinueStatement :
	'continue' ruleBindingIdentifier? ruleSemi
;

// Rule ContinueStatement
norm1_ContinueStatement :
	'continue' norm1_BindingIdentifier? ruleSemi
;

// Rule BreakStatement
ruleBreakStatement :
	'break' ruleBindingIdentifier? ruleSemi
;

// Rule BreakStatement
norm1_BreakStatement :
	'break' norm1_BindingIdentifier? ruleSemi
;

// Rule ReturnStatement
ruleReturnStatement :
	'return' norm1_Expression? ruleSemi
;

// Rule ReturnStatement
norm1_ReturnStatement :
	'return' norm3_Expression? ruleSemi
;

// Rule WithStatement
ruleWithStatement :
	'with' '(' norm1_Expression ')' ruleStatement
;

// Rule WithStatement
norm1_WithStatement :
	'with' '(' norm3_Expression ')' norm1_Statement
;

// Rule SwitchStatement
ruleSwitchStatement :
	'switch' '(' norm1_Expression ')' '{' ruleCaseClause* (
		ruleDefaultClause ruleCaseClause*
	)? '}'
;

// Rule SwitchStatement
norm1_SwitchStatement :
	'switch' '(' norm3_Expression ')' '{' norm1_CaseClause* (
		norm1_DefaultClause norm1_CaseClause*
	)? '}'
;

// Rule CaseClause
ruleCaseClause :
	'case' norm1_Expression ':' ruleStatement*
;

// Rule CaseClause
norm1_CaseClause :
	'case' norm3_Expression ':' norm1_Statement*
;
...
// Rule ThrowStatement
ruleThrowStatement :
	'throw' norm1_Expression ruleSemi
;

// Rule ThrowStatement
norm1_ThrowStatement :
	'throw' norm3_Expression ruleSemi
;
...
ruleTryStatement :
	...
	'{'
		...
		ruleCatchBlock ruleFinallyBlock? |
		ruleFinallyBlock
	)
;
...
norm1_TryStatement :
	...
	'{'
		...
		norm1_CatchBlock norm1_FinallyBlock? |
		norm1_FinallyBlock
	)
;
...
ruleArrayLiteral :
	'[' ruleArrayPadding* (
		ruleArrayElement (
			',' ruleArrayPadding* ruleArrayElement
		)* (
			',' ruleArrayPadding*
		)?
	)? ']'
...
norm1_ArrayLiteral :
	'[' ruleArrayPadding* (
		norm1_ArrayElement (
			',' ruleArrayPadding* norm1_ArrayElement
		)* (
			',' ruleArrayPadding*
		)?
	)? ']'
...
norm1_AnnotatedPropertyAssignment :
	rulePropertyAssignmentAnnotationList (
		...
		ruleTypeRef? norm1_IdentifierRef (
			'=' norm3_AssignmentExpression
		)?
	)
;
...
ruleParameterizedCallExpression :
	ruleTypeArguments ruleIdentifierRef ruleArgumentsWithParentheses
;

// Rule ParameterizedCallExpression
norm1_ParameterizedCallExpression :
	ruleTypeArguments norm1_IdentifierRef norm1_ArgumentsWithParentheses
;
...
ruleParameterizedPropertyAccessExpressionTail :
	'.' ruleTypeArguments? ruleIdentifierName
;
...
ruleUnaryExpression :
	ruleCastExpression |
	ruleUnaryOperator ruleUnaryExpression
;

// Rule UnaryExpression
norm1_UnaryExpression :
	norm1_CastExpression |
	ruleUnaryOperator norm1_UnaryExpression
;
...
ruleMultiplicativeExpression :
	ruleUnaryExpression (
		...
		) => ruleMultiplicativeOperator ) ruleUnaryExpression
	)*
;
...
norm1_MultiplicativeExpression :
	norm1_UnaryExpression (
		( (
		ruleMultiplicativeOperator
		) => ruleMultiplicativeOperator ) norm1_UnaryExpression
	)*
;
...
norm1_AdditiveExpression :
	norm1_MultiplicativeExpression (
		( (
		ruleAdditiveOperator
		) => ruleAdditiveOperator ) norm1_MultiplicativeExpression
	)*
;
...
ruleShiftExpression :
	ruleAdditiveExpression ( (
	ruleShiftOperator ruleAdditiveExpression
	) => (
		ruleShiftOperator ruleAdditiveExpression
	) )*
;
...
norm1_ShiftExpression :
	norm1_AdditiveExpression ( (
	ruleShiftOperator norm1_AdditiveExpression
	) => (
		ruleShiftOperator norm1_AdditiveExpression
	) )*
;
...
ruleEqualityExpression :
	ruleRelationalExpression (
		...
		) => ruleEqualityOperator ) ruleRelationalExpression
	)*
;
...
norm1_EqualityExpression :
	norm1_RelationalExpression (
		( (
		ruleEqualityOperator
		) => ruleEqualityOperator ) norm1_RelationalExpression
	)*
;
...
norm2_EqualityExpression :
	norm2_RelationalExpression (
		( (
		ruleEqualityOperator
		) => ruleEqualityOperator ) norm2_RelationalExpression
	)*
;
...
norm3_EqualityExpression :
	norm3_RelationalExpression (
		( (
		ruleEqualityOperator
		) => ruleEqualityOperator ) norm3_RelationalExpression
	)*
;
...
ruleBitwiseANDExpression :
	ruleEqualityExpression (
		...
		) => ruleBitwiseANDOperator ) ruleEqualityExpression
	)*
;
...
norm1_BitwiseANDExpression :
	norm1_EqualityExpression (
		( (
		ruleBitwiseANDOperator
		) => ruleBitwiseANDOperator ) norm1_EqualityExpression
	)*
;
...
norm2_BitwiseANDExpression :
	norm2_EqualityExpression (
		( (
		ruleBitwiseANDOperator
		) => ruleBitwiseANDOperator ) norm2_EqualityExpression
	)*
;
...
norm3_BitwiseANDExpression :
	norm3_EqualityExpression (
		( (
		ruleBitwiseANDOperator
		) => ruleBitwiseANDOperator ) norm3_EqualityExpression
	)*
;
...
ruleBitwiseXORExpression :
	ruleBitwiseANDExpression (
		...
		) => ruleBitwiseXOROperator ) ruleBitwiseANDExpression
	)*
;
...
norm1_BitwiseXORExpression :
	norm1_BitwiseANDExpression (
		( (
		ruleBitwiseXOROperator
		) => ruleBitwiseXOROperator ) norm1_BitwiseANDExpression
	)*
;
...
norm2_BitwiseXORExpression :
	norm2_BitwiseANDExpression (
		( (
		ruleBitwiseXOROperator
		) => ruleBitwiseXOROperator ) norm2_BitwiseANDExpression
	)*
;
...
norm3_BitwiseXORExpression :
	norm3_BitwiseANDExpression (
		( (
		ruleBitwiseXOROperator
		) => ruleBitwiseXOROperator ) norm3_BitwiseANDExpression
	)*
;
...
ruleBitwiseORExpression :
	ruleBitwiseXORExpression (
		...
		) => ruleBitwiseOROperator ) ruleBitwiseXORExpression
	)*
;
...
norm1_BitwiseORExpression :
	norm1_BitwiseXORExpression (
		( (
		ruleBitwiseOROperator
		) => ruleBitwiseOROperator ) norm1_BitwiseXORExpression
	)*
;
...
norm2_BitwiseORExpression :
	norm2_BitwiseXORExpression (
		( (
		ruleBitwiseOROperator
		) => ruleBitwiseOROperator ) norm2_BitwiseXORExpression
	)*
;
...
norm3_BitwiseORExpression :
	norm3_BitwiseXORExpression (
		( (
		ruleBitwiseOROperator
		) => ruleBitwiseOROperator ) norm3_BitwiseXORExpression
	)*
;
...
ruleLogicalANDExpression :
	ruleBitwiseORExpression (
		...
		) => ruleLogicalANDOperator ) ruleBitwiseORExpression
	)*
;
...
norm1_LogicalANDExpression :
	norm1_BitwiseORExpression (
		( (
		ruleLogicalANDOperator
		) => ruleLogicalANDOperator ) norm1_BitwiseORExpression
	)*
;
...
norm2_LogicalANDExpression :
	norm2_BitwiseORExpression (
		( (
		ruleLogicalANDOperator
		) => ruleLogicalANDOperator ) norm2_BitwiseORExpression
	)*
;
...
norm3_LogicalANDExpression :
	norm3_BitwiseORExpression (
		( (
		ruleLogicalANDOperator
		) => ruleLogicalANDOperator ) norm3_BitwiseORExpression
	)*
;
...
ruleLogicalORExpression :
	ruleLogicalANDExpression (
		...
		) => ruleLogicalOROperator ) ruleLogicalANDExpression
	)*
;
...
norm1_LogicalORExpression :
	norm1_LogicalANDExpression (
		( (
		ruleLogicalOROperator
		) => ruleLogicalOROperator ) norm1_LogicalANDExpression
	)*
;
...
norm2_LogicalORExpression :
	norm2_LogicalANDExpression (
		( (
		ruleLogicalOROperator
		) => ruleLogicalOROperator ) norm2_LogicalANDExpression
	)*
;
...
norm3_LogicalORExpression :
	norm3_LogicalANDExpression (
		( (
		ruleLogicalOROperator
		) => ruleLogicalOROperator ) norm3_LogicalANDExpression
	)*
;
...
ruleConditionalExpression :
	ruleLogicalORExpression (
		( (
		'?'
		) => '?' ) norm1_AssignmentExpression ':' ruleAssignmentExpression
	)?
;
...
norm2_ConditionalExpression :
	norm2_LogicalORExpression (
		( (
		'?'
		) => '?' ) norm3_AssignmentExpression ':' norm2_AssignmentExpression
	)?
;
...
ruleAssignmentExpression :
	...
	ruleConditionalExpression (
		...
		) => ruleAssignmentOperator ) ruleAssignmentExpression
	)?
;
...
norm1_AssignmentExpression :
	...
	norm1_ConditionalExpression (
		( (
		ruleAssignmentOperator
		) => ruleAssignmentOperator ) norm1_AssignmentExpression
	)?
;
...
norm2_AssignmentExpression :
	...
	norm2_ConditionalExpression (
		( (
		ruleAssignmentOperator
		) => ruleAssignmentOperator ) norm2_AssignmentExpression
	)?
;
...
norm3_AssignmentExpression :
	...
	norm3_ConditionalExpression (
		( (
		ruleAssignmentOperator
		) => ruleAssignmentOperator ) norm3_AssignmentExpression
	)?
;
...
ruleAwaitExpression :
	( (
	'await'
	) => 'await' ) ruleAssignmentExpression
;
...
norm1_AwaitExpression :
	( (
	'await'
	) => 'await' ) norm1_AssignmentExpression
;
...
norm2_AwaitExpression :
	( (
	'await'
	) => 'await' ) norm2_AssignmentExpression
;
...
norm3_AwaitExpression :
	( (
	'await'
	) => 'await' ) norm3_AssignmentExpression
;
...
ruleTemplateLiteral :
	...
	ruleTemplateHead norm1_Expression? ruleTemplateExpressionEnd (
		ruleTemplateMiddle norm1_Expression? ruleTemplateExpressionEnd
	)* ruleTemplateTail
;
...
norm1_TemplateLiteral :
	ruleNoSubstitutionTemplate |
	ruleTemplateHead norm3_Expression? ruleTemplateExpressionEnd (
		ruleTemplateMiddle norm3_Expression? ruleTemplateExpressionEnd
	)* ruleTemplateTail
;
...
ruleN4ClassDeclaration :
	...
	ruleBindingIdentifier?
		...
		ruleN4Modifier* 'class' ruleTypingStrategyDefSiteOperator?
		ruleBindingIdentifier?
	) ) ruleTypeVariables? ruleClassExtendsClause? ruleMembers
;
...
ruleClassExtendsClause :
	...
	'implements' ruleClassImplementsList
;
...
ruleN4InterfaceDeclaration :
	...
	ruleBindingIdentifier?
		...
		ruleN4Modifier* 'interface' ruleTypingStrategyDefSiteOperator?
		ruleBindingIdentifier?
	) ) ruleTypeVariables? ruleInterfaceImplementsList? ruleMembers
;
...
ruleN4MemberDeclaration :
	...
	( (
	ruleN4Modifier* ruleGetterHeader
...
norm1_N4MemberDeclaration :
	...
	( (
	ruleN4Modifier* norm1_GetterHeader
...
ruleGetterHeader :
	...
	RULE_HEX_INT |
	RULE_SCIENTIFIC_INT
	) => ruleLiteralOrComputedPropertyName ) '(' ')' ruleColonSepTypeRef?
;
...
norm1_GetterHeader :
	...
	RULE_HEX_INT |
	RULE_SCIENTIFIC_INT
	) => norm1_LiteralOrComputedPropertyName ) '(' ')' ruleColonSepTypeRef?
;
...
ruleArrayBindingPattern :
	'[' ruleElision* (
		ruleBindingRestElement (
			',' ruleElision* ruleBindingRestElement
		)* (
			',' ruleElision*
		)?
	)? ']'
...
norm1_ArrayBindingPattern :
	'[' ruleElision* (
		norm1_BindingRestElement (
			',' ruleElision* norm1_BindingRestElement
		)* (
			',' ruleElision*
		)?
	)? ']'
...
RULE_DOUBLE :
	'.' RULE_DECIMAL_DIGIT_FRAGMENT+ RULE_EXPONENT_PART? |
	RULE_DECIMAL_INTEGER_LITERAL_FRAGMENT '.' RULE_DECIMAL_DIGIT_FRAGMENT*
	RULE_EXPONENT_PART?
;
...
RULE_LEGACY_OCTAL_INT :
	'0' RULE_DECIMAL_DIGIT_FRAGMENT RULE_INT_SUFFIX
;

fragment RULE_INT_SUFFIX :
	RULE_IDENTIFIER_PART*
;

RULE_SCIENTIFIC_INT :
	RULE_DECIMAL_INTEGER_LITERAL_FRAGMENT RULE_EXPONENT_PART
;

fragment RULE_EXPONENT_PART :
	(
		'e' |
		'E'
	) RULE_SIGNED_INT |
...
fragment RULE_SIGNED_INT :
	(
		'+' |
		'-'
	) RULE_DECIMAL_DIGIT_FRAGMENT+ RULE_IDENTIFIER?
;

RULE_STRING :
	'"' RULE_DOUBLE_STRING_CHAR* '"'? |
	'\'' RULE_SINGLE_STRING_CHAR* '\''?
;

fragment RULE_DOUBLE_STRING_CHAR :
	~ (
		RULE_LINE_TERMINATOR_FRAGMENT |
		'"' |
		'\\'
	) |
	'\\' (
		RULE_LINE_TERMINATOR_SEQUENCE_FRAGMENT |
		~ (
			RULE_LINE_TERMINATOR_FRAGMENT
		)
	)?
...
fragment RULE_SINGLE_STRING_CHAR :
	~ (
		RULE_LINE_TERMINATOR_FRAGMENT |
		'\'' |
		'\\'
...
fragment RULE_BACKSLASH_SEQUENCE :
	'\\' ~ (
		RULE_LINE_TERMINATOR_FRAGMENT
	)?
;

fragment RULE_REGEX_CHAR :
	~ (
		RULE_LINE_TERMINATOR_FRAGMENT |
		'\\' |
		'/' |
	...
	RULE_BACKSLASH_SEQUENCE |
	'[' RULE_REGEX_CHAR_OR_BRACKET* ']'?
;

fragment RULE_REGEX_CHAR_OR_BRACKET :
	~ (
		RULE_LINE_TERMINATOR_FRAGMENT |
		'\\' |
		']'
...
fragment RULE_ACTUAL_REGEX_TAIL :
	RULE_REGEX_CHAR+ (
		'/' RULE_IDENTIFIER_PART*
	)? |
	'/' RULE_IDENTIFIER_PART*
...
fragment RULE_ACTUAL_TEMPLATE_END :
	RULE_TEMPLATE_LITERAL_CHAR* (
		'$'+ (
			'{' |
			'`'?
...
fragment RULE_TEMPLATE_LITERAL_CHAR :
	~ (
		RULE_LINE_TERMINATOR_FRAGMENT |
		'`' |
		'\\' |
...
fragment RULE_TEMPLATE_CONTINUATION :
	'//4'
;
...
RULE_INT :
	RULE_DECIMAL_INTEGER_LITERAL_FRAGMENT
;

RULE_ML_COMMENT :
	RULE_ML_COMMENT_FRAGMENT { skip(); }
;
...
RULE_EOL :
	RULE_LINE_TERMINATOR_SEQUENCE_FRAGMENT { skip(); }
;

RULE_WS :
	RULE_WHITESPACE_FRAGMENT+ { skip(); }
;

fragment RULE_UNICODE_ESCAPE_FRAGMENT :
	'\\' (
		'u' (
			RULE_HEX_DIGIT (
				RULE_HEX_DIGIT (
...
fragment RULE_IDENTIFIER_START :
	RULE_UNICODE_LETTER_FRAGMENT |
	'$' |
	'_' |
	RULE_UNICODE_ESCAPE_FRAGMENT
;
...
fragment RULE_IDENTIFIER_PART :
	...
	RULE_UNICODE_ESCAPE_FRAGMENT |
	'$' |
	RULE_UNICODE_COMBINING_MARK_FRAGMENT |
	RULE_UNICODE_DIGIT_FRAGMENT |
	RULE_UNICODE_CONNECTOR_PUNCTUATION_FRAGMENT |
	RULE_ZWNJ |
	RULE_ZWJ
;
...
fragment RULE_DECIMAL_INTEGER_LITERAL_FRAGMENT :
	'0' |
	'1' .. '9' RULE_DECIMAL_DIGIT_FRAGMENT*
;

fragment RULE_DECIMAL_DIGIT_FRAGMENT :
	'0' .. '9'
;
...
fragment RULE_WHITESPACE_FRAGMENT :
	'\t' |
	'\u000B' |
	'\f' |
	' ' |
	'\u00A0' |
	RULE_BOM |
	RULE_UNICODE_SPACE_SEPARATOR_FRAGMENT
;
...
fragment RULE_SL_COMMENT_FRAGMENT :
	'//' ~ (
		RULE_LINE_TERMINATOR_FRAGMENT
	)*
;

fragment RULE_ML_COMMENT_FRAGMENT :
	'/*' (
		options { greedy = false ; } : .
	)* '*/'
;

fragment RULE_UNICODE_COMBINING_MARK_FRAGMENT :
	'\u0300' .. '\u036F' |
	'\u0483' .. '\u0487' |
	'\u0591' .. '\u05BD' |
	'\u05BF' |
...
fragment RULE_UNICODE_DIGIT_FRAGMENT :
	'0' .. '9' |
	'\u0660' .. '\u0669' |
	'\u06F0' .. '\u06F9' |
	'\u07C0' .. '\u07C9' |
...
fragment RULE_UNICODE_CONNECTOR_PUNCTUATION_FRAGMENT :
	'_' |
	'\u203F' .. '\u2040' |
	'\u2054' |
	'\uFE33' .. '\uFE34' |
...
fragment RULE_UNICODE_LETTER_FRAGMENT :
	'A' .. 'Z' |
	'a' .. 'z' |
	'\u00AA' |
	'\u00B5' |
