...
(
    ...
    {
        $current = $this_ClassExtendsClause_15.current;
        afterParserOrEnumRuleCall();
    }
)?)
    |((
...
(
    ...
    {
        $current = $this_InterfaceImplementsList_22.current;
        afterParserOrEnumRuleCall();
    }
)?))
    { 
...
ruleBindingIdentifier
    ...
    {
        $current = $this_ExportedFunctionDeclaration_4.current;
        afterParserOrEnumRuleCall();
    }
...
(
    ...
    {
        $current = $this_ClassExtendsClause_18.current;
        afterParserOrEnumRuleCall();
    }
)?)
    |((
...
(
    ...
    {
        $current = $this_InterfaceImplementsList_25.current;
        afterParserOrEnumRuleCall();
    }
)?))
    { 
...
entryRuleExportedFunctionDeclaration returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getExportedFunctionDeclarationRule()); }
	 ...
	 { $current=$iv_ruleExportedFunctionDeclaration.current; } 
	 EOF 
;

// Rule ExportedFunctionDeclaration
ruleExportedFunctionDeclaration returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((((
...
(
    ...
    {
        $current = $this_NoLineTerminator_8.current;
        afterParserOrEnumRuleCall();
    }
...
(
	...
	otherlv_17=EqualsSignGreaterThanSign
    {
...
(
    ...
    {
        $current = $this_ClassExtendsClause_4.current;
        afterParserOrEnumRuleCall();
    }
)?
    { 
...
(
    ...
    {
        $current = $this_ColonSepTypeRef_5.current;
        afterParserOrEnumRuleCall();
    }
)?))(
...
LeftParenthesis
    ...
    {
        $current = $this_MethodParamsAndBody_21.current;
        afterParserOrEnumRuleCall();
    }
))
    |((
...
LeftParenthesis
    ...
    {
        $current = $this_MethodParamsAndBody_23.current;
        afterParserOrEnumRuleCall();
    }
)))))(
	otherlv_24=Semicolon
...
(
    ...
    {
        $current = $this_TypeArguments_0.current;
        afterParserOrEnumRuleCall();
    }
(
(
...
LessThanSign
    ...
    {
        $current = $this_TypeArguments_7.current;
        afterParserOrEnumRuleCall();
    }
)?(((
(
...
entryRuleQualifiedTypeReferenceName returns [String current=null] 
:
	{ newCompositeNode(grammarAccess.getQualifiedTypeReferenceNameRule()); } 
	 ...
	 { $current=$iv_ruleQualifiedTypeReferenceName.current.getText(); }  
	 EOF 
;

// Rule QualifiedTypeReferenceName
ruleQualifiedTypeReferenceName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule();
    }:
...
(
    ...
    {
        $current = $this_ClassExtendsClause_6.current;
        afterParserOrEnumRuleCall();
    }
)?
    { 
...
(
    ...
    {
        $current = $this_ClassImplementsList_4.current;
        afterParserOrEnumRuleCall();
    }
)?)
    |(
(
    ...
    {
        $current = $this_ClassImplementsList_7.current;
        afterParserOrEnumRuleCall();
    }
))
;
...
(
    ...
    {
        $current = $this_InterfaceImplementsList_6.current;
        afterParserOrEnumRuleCall();
    }
)?
    { 
...
ruleInterfaceImplementsList [EObject in_current] returns [EObject current=in_current] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
)*(ruleTypeVariables[null])?(ruleBogusTypeRefFragment[null])?(((
(
...
(
    ...
    {
        $current = $this_BogusTypeRefFragment_18.current;
        afterParserOrEnumRuleCall();
    }
)?(((
(
...
LeftParenthesis
    ...
    {
        $current = $this_MethodParamsReturnAndBody_21.current;
        afterParserOrEnumRuleCall();
    }
))
    |(
    ...
    {
        $current = $this_AsyncNoTrailingLineBreak_22.current;
        afterParserOrEnumRuleCall();
    }
(
(
...
LeftParenthesis
    ...
    {
        $current = $this_MethodParamsReturnAndBody_24.current;
        afterParserOrEnumRuleCall();
    }
)))))(
    ...
    {
        $current = $this_FieldDeclarationImpl_27.current;
        afterParserOrEnumRuleCall();
    }
)))
;
...
(
    ...
    {
        $current = $this_ColonSepTypeRef_3.current;
        afterParserOrEnumRuleCall();
    }
)?(
...
(
    ...
    {
        $current = $this_ArrayTypeRef_6.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_TypeRefWithModifiers_7.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_TypeRef_9.current;
        afterParserOrEnumRuleCall();
    }
...
entryRuleBogusTypeRef returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getBogusTypeRefRule()); }
	 iv_ruleBogusTypeRef=ruleBogusTypeRef 
	 { $current=$iv_ruleBogusTypeRef.current; } 
	 EOF 
;

// Rule BogusTypeRef
ruleBogusTypeRef returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
    ...
    {
        $current = $this_TypeRefWithModifiers_0.current;
        afterParserOrEnumRuleCall();
    }
...
(
    ...
    {
        $current = $this_ArrayTypeRef_1.current;
        afterParserOrEnumRuleCall();
    }
...
entryRuleArrayTypeRef returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getArrayTypeRefRule()); }
	 iv_ruleArrayTypeRef=ruleArrayTypeRef 
	 { $current=$iv_ruleArrayTypeRef.current; } 
	 EOF 
;

// Rule ArrayTypeRef
ruleArrayTypeRef returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
(
		lv_arrayTypeLiteral_0_0=
	LeftSquareBracket
    {
...
(
    ...
    {
        $current = $this_TAnonymousFormalParameterList_8.current;
        afterParserOrEnumRuleCall();
    }
